...
class ParameterOptimizationCLRv4(ParameterOptimization):
    
    def __init__(self):
        self.study_name = 'nnclr_v4'
        self.plot_path = c.plots_path + "optuna/nnclr_v4/"
        self.direction = ['minimize']
    ...
    def _objective(self, trail):
        ...
        try:
            ...
            loss = train_clr(params=params_trail, save_model=trial.number, experiment_tracking=True)
            return loss
...
if __name__ == "__main__":
    ...
    opt = ParameterOptimizationCLRv4()
    opt.run()
